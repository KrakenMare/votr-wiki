...
// Import API Routes
app.use('/', __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */]);
...
module.exports = {
  ...
  */
  head: {
    ...
    link: [{ rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' }, { rel: 'stylesheet', href: 'https://cdnjs.cloudflare.com/ajax/libs/bulma/0.6.1/css/bulma.min.css' }]
  },
  /*
  ** Global CSS
  */
