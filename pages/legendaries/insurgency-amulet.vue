          ...
          <section class="hero is-danger is-bold is-small promo-block">
            <div class="hero-body">
              <div class="container">
                ...
                <h2 class="subtitle">
                  Boundless energies fill this gemstone..
                </h2>
              </div>
            </div>
            ...
            <div class="content article-body">
                <img src="https://i.imgur.com/6znDTwk.png" class="image is-128x128" alt="insurgency amulet">
                <h3>Stats.</h3>
                <p>
                    <li>+200 HP</li>
                    <li>+20 PROTECTION</li>
                ...
                <h3>Usage.</h3>
                <p>
                    <li>The passive of the ring goes well in combination with other items that boost your protection stat, as it is easier to get full surge and fill up your protection bar</li>
                </p>
              </div>
            </div>
          </div>
