          ...
          <section class="hero is-danger is-bold is-small promo-block">
            <div class="hero-body">
              <div class="container">
                ...
                <h2 class="subtitle">
                  A shield forged for the most outstanding of knights that also has magical aspects.
                </h2>
              </div>
            </div>
            ...
            <div class="content article-body">
                <img src="https://i.imgur.com/6znDTwk.png" class="image is-128x128" alt="protector of grandeur">
                <h3>Stats.</h3>
                <p>
                    <li>SHOTS: 8</li>
                    <li>DAMAGE: 380-420</li>
                    <li>RANGE: 3.2</li>
                    <li>Shots hit multiple targets</li>
                    <li>Shots pass through obstacles</li>
                    <li>Stuns for 4.25 seconds</li>
                    <li>+15 DEFENSE</li>
                    <li>+2 RESTORATION</li>
                    <li>+40 HP</li>
                    <li>+12 DEXTERITY</li>
