<template>
    ...
    <nav class="navbar is-white">
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/burden-of-the-warpawn" class="navbar-item">Burden of the Warpawn</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/gargoyle-stoneplate" class="navbar-item">Gargoyle Stoneplate</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/the-odyssey" class="navbar-item">The Odyssey</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/the-executioner" class="navbar-item">The Executioner</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/gargoyle-slayer" class="navbar-item">Gargoyle Slayer</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/gargoyle-crusher" class="navbar-item">Gargoyle Crusher</nuxt-link>
                    ...
                    <span class="tag">Page</span>
                          ...
                          <div class="box content">
          <article class="post">
            <h4>Legendary Bracelet of the Demolished</h4>
            <span class="pull-right has-text-grey-light"><i class="fa fa-comments"></i> 1</span>
            <div class="media">
              <div class="media-left">
                <p class="image is-32x32">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/bracelet-of-the-demolished" class="navbar-item">Bracelet of the Demolished</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/hand-of-zeus" class="navbar-item">Hand of Zeus</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/the-2-k" class="navbar-item">The 2-k</nuxt-link>
          ...
          <article class="post">
            ...
            <div class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/the-infernus" class="navbar-item">The Infernus</nuxt-link>
      ...
      <div class="column is-center">
        <div class="box content">
          <article class="post">
            <h4>Legendary Revenant Prism</h4>
            <span class="pull-right has-text-grey-light"><i class="fa fa-comments"></i> 1</span>
            <div class="media">
              <div class="media-left">
                <p class="image is-32x32">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <nuxt-link to="/legendaries/revenant-prism" class="navbar-item">Revenant Prism</nuxt-link>
