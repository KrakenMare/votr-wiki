        ...
        <div class="column is-8 is-offset-2">
          ...
          <section class="hero is-danger is-bold is-small promo-block">
            ...
            <div class="content article-body">
                ...
                <h3>Usage.</h3>
                <p>
                    <li class="is-center">This katana does not hit the full 7.7 range, it boomerangs back, it however has very high dps and is great for crowd control because it pierces through enemies </li>
                </p>
              </div>
            </div>
          </div>
